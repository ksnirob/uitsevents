...
<html>
  ...
  <div class ="content">
    ...
    <input type="file" name="img_link" required class="form-control"><br><br>
    ...
    <button type="submit" name="update" class = "btn btn-primary pull-right">Create Event <span class="glyphicon glyphicon-send"></span></button>
